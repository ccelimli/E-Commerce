...
public class RegularExpression {
    public static boolean controlFirstNameAndLastName(String firstName, String lastName) {
        Pattern pattern = Pattern.compile(RegexConstants.FIRST_NAME_LAST_NAME_REGEX.getContext());
    ...
    public static boolean controlEmail(String email) {
        Pattern pattern = Pattern.compile(RegexConstants.EMAIL_REGEX.getContext());
    ...
    public static boolean controlPhoneNumber(String phoneNumber) {
        Pattern pattern = Pattern.compile(RegexConstants.PHONE_NUMBER_REGEX.getContext());
